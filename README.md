# nvim-treesitter-queries-pioasm

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-pioasm/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-pioasm/actions/workflows/validate.yml)

Neovim tree-sitter queries for **pioasm**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-pioasm",
...
- [ ] Changes are scoped to `pioasm` — do not include files for other languages
